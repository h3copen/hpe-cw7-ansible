"""Manage connections to COM7 devices.
...
from pycw7.features.facts import Facts
import time
import socket
from lxml import etree
from pycw7.utils.xml.namespaces import NETCONFBASE_C
from pycw7.errors import NCTimeoutError, ConnectionClosedError, NCError,\
...
class COM7(object):
    ...
    Args:
        host: REQUIRED - hostname or IP address of the Comware Switch
    ...
    def open(self,
             ...
             allow_agent=False,
             look_for_keys=False):
        """Open the NETCONF connection to the switch.
    ...
    def close(self):
        """Close the NETCONF connection to the switch.
        """
        try:
            if self.connected:
